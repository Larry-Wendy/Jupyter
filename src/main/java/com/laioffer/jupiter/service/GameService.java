...
public class GameService {
    ...
    private static final String TOKEN = "Bearer 5v209dptjnd7p93xop2g1857cdeg6a";
    private static final String CLIENT_ID = "fcwsblugpl2w13lktljknoalnu3de5";
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        ResponseHandler<String> responseHandler = response -> { // call back 类似JS中的arrow function
